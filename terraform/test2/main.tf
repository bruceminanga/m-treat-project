...
resource "aws_s3_bucket" "app_media" {
  ...
  bucket = "my-company-${var.environment}-django-media-bucket"
...
resource "aws_iam_role" "app_server_role" {
  name = "django-server-${var.environment}-s3-access-role"
...
resource "aws_iam_instance_profile" "app_server_profile" {
  name = "django-server-${var.environment}-instance-profile-test2"
